...
# Setup
st.set_page_config(page_title="UI Showcase", layout="centered")
...
st.markdown('<div class="widget-title">🧪 UI Components Showcase</div>', unsafe_allow_html=True)
...
st.download_button('On the dl', data=download_content, file_name='demo.txt')
